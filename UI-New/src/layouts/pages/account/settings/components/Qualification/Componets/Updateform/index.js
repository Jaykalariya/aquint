...
function Updateform({ Selecteddata, sethide, fetchData }) {
  ...
  return (
    <div>
      <SoftBox p={3}>
        <Typography variant="h5">Update Qualification Details</Typography>
      </SoftBox>
      <SoftBox component="form" pb={3} px={3}>
        <Grid container spacing={3}>
          <Grid item xs={6}>
            ...
            {submitted && !formData.qualificationName && (
              <span style={{ color: "red", fontSize: "12px" }}>Please Enter QualificationName</span>
            )}
          </Grid>
          <Grid item xs={6}>
            <label className="text-xs font-bold p-1">
        ...
        <Grid container spacing={3}>
          <Grid item xs={6}>
            ...
            <SoftInput value={formData.subject} onChange={(e) => handleInputChange(e, "subject")} />
