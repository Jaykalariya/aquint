...
function Update({
  ...
  useEffect(() => {
    if (selectedItemData) {
      const selectedProductTypeOption = findOptionByValue(
        selectedItemData["productType"],
        productTypeOptions
      );
      const selectedGstSlabsOption = findOptionByValue(
        selectedItemData["gstSlab"],
        gstSlabsOptions
      );
      const selectedUnitOption = findOptionByValue(selectedItemData["unit"], unitOptions);
      const selectedEsclTypeOption = findOptionByValue(
        selectedItemData["esclType"],
        esclTypeOptions
      );
      const selectedWithGstOption = findOptionByValue(selectedItemData["withGst"], withGstOptions);
      console.log(
        selectedProductTypeOption + " " + selectedUnitOption + " " + selectedGstSlabsOption
      );
        ...
        <SoftBox>
          ...
          <div className="md:grid md:grid-cols-3 md:gap-5">
            ...
            <div>
              ...
              {unitRateError && (
                <span style={{ color: "red", fontSize: "12px" }}>
                  Please enter a valid unit rate
                </span>
              )}
            </div>
          ...
          <div className="md:grid md:grid-cols-3 md:gap-5">
            ...
            <div>
              ...
              {esclTypeError && (
                <span style={{ color: "red", fontSize: "12px" }}>
                  Please enter a valid ESCL type
                </span>
              )}
            </div>
