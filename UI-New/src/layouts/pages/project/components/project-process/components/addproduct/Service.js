...
async function Service(projectId, productTypeId,itemCode,itemQuantity,unitId,unitRate,basicValue,esclType,esclPercentage,gstSlabsId,amount,withGst,biddingUnit) {
