...
function Tenderinfo({ tenderid }) {
  ...
  const getSubmissionDate = (submissionDate) => {
    const differenceInDays = Math.floor(
      (formatSubmissionDate(submissionDate) - new Date(currentDate)) / (24 * 60 * 60 * 1000)
    );
    ...
    if (differenceInDays < 0) {
      return (
        <div style={{ color: "Red" }} className="text-base">
          ...
          <div style={{ color: "#ff2525", fontStyle: "italic", fontSize: "0.8rem" }}>
            !Tender has passed the submission date, We missed it
          </div>
        </div>
      );
      ...
      return (
        <div style={{ color: "Red" }} className="text-base">
          {formatDate(submissionDate) || "N/A"}
          <div style={{ color: "#ff2525", fontStyle: "italic", fontSize: "0.8rem" }}>
            Today is the last date to submit
          </div>
        </div>
      );
      ...
      return (
        <div style={{ color: "Orange" }} className="text-base">
          {formatDate(submissionDate) || "N/A"}
          <div style={{ color: "#ff2525", fontStyle: "italic", fontSize: "0.8rem" }}>
            Only {differenceInDays} days left
          </div>
        </div>
      );
    } else {
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-2">
            ...
            <SoftBox style={customStyles} className="border-b mb-2 p-4">
              <SoftTypography
                style={{ fontWeight: "500", color: "#122d48", fontSize: "0.9rem" }}
                variant="caption"
                color="text"
          ...
          <div className="grid grid-cols-2">
            ...
            <SoftBox className="border-b mb-2 p-4" style={customStyles}>
              ...
              <div>{getSubmissionDate(tender.submissionDate)}</div>
            </SoftBox>
          </div>
